    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($validated, $agencyId, $request) {
                ...
                Log::info('Starting client creation transaction for: ' . $validated['email']);
                ...
                Log::info('About to create client with user_id: ' . $user->id);
                ...
                Log::info('Client created successfully with ID: ' . $client->id . ' and user_id: ' . $client->user_id);
