...
class ScheduleController extends Controller
{
        ...
        try {
            ...
            if ($is_admin) {
                try {
                    ...
                    $this->logError($e, 'firebase_signature_url_generation');
                    // Continue without signature URLs if Firebase fails
                }
            }
            ...
            return $this->handleException($e, 'Unable to load schedule. Please try again.', 'schedule_index');
        }
    }
    ...
    public function clientSchedule()
    {
        try {
            ...
            return $this->handleException($e, 'Unable to load your schedule. Please try again.', 'client_schedule');
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                $this->logError($e, 'shift_event_dispatch');
    ...
    public function update(Request $request, Shift $shift)
    {
        ...
        try {
            ...
            // Handle signature URLs for admin views
            if ($shift->visit) {
                try {
                    $shift->visit->clock_in_signature_url = $shift->visit->signature_path
                        ? $this->firebaseStorageService->getPublicUrl($shift->visit->signature_path) : null;
            ...
            $eventData = [
                ...
                'extendedProps' => [
                    ...
                    'visit' => $shift->visit ? [
                        'clock_in_time' => $shift->visit->clock_in_time,
                        'clock_out_time' => $shift->visit->clock_out_time,
                        'clock_in_signature_url' => $shift->visit->clock_in_signature_url ?? null,
                        'clock_out_signature_url' => $shift->visit->clock_out_signature_url ?? null,
                    ] : null
                ]
            ];
    ...
    public function destroy(Shift $shift)
    {
        ...
        try {
            ...
            $this->logError($e, 'shift_deletion');
