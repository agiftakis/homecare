<x-guest-layout>
    <div x-data="{ showSuccess: {{ session('success') ? 'true' : 'false' }} }" class="min-h-screen bg-gray-50 dark:bg-gray-800 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">

            <div class="flex justify-center mb-8">
                <a href="{{ url('/') }}" class="flex items-center space-x-3">
                    <img src="{{ asset('images/vitalink-logo.png') }}" alt="VitaLink Logo" class="h-20 w-auto">
                    <span class="text-3xl font-bold text-gray-800 dark:text-white">VitaLink</span>
                </a>
            </div>
            ...
            <div class="bg-white dark:bg-gray-900 shadow-2xl rounded-lg overflow-hidden">
                <div class="px-6 py-8 sm:p-10">
                    ...
                    <p class="text-center text-md text-gray-600 dark:text-gray-300 mb-6">
                        We're excited to show you how VitaLink can revolutionize your agency. Please fill out the form below to get in touch with our team.
                    </p>

                    <div class="bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-700 rounded-lg p-5 mb-8">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
                            This includes full access to all features, all future updates, and dedicated support. No monthly fees, ever.
                        </p>
                    </div>
        ...
        <div x-show="showSuccess"
            ...
            <div @click.away="showSuccess = false"
                ...
                <button @click="showSuccess = false" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                </button>

                <div class="flex justify-center items-center h-16 w-16 mx-auto bg-green-100 rounded-full border-4 border-green-300 dark:bg-green-900/30 dark:border-green-600">
                    <svg class="w-10 h-10 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                </div>

                <h3 class="text-2xl font-semibold text-center text-gray-900 dark:text-white mt-6 mb-2">
                    Submission Received!
                </h3>
                <p class="text-center text-gray-600 dark:text-gray-300">
                    Thank you for your interest in VitaLink. A member of our team will be in touch very soon to schedule your consultation and get you started with a 14-day trial.
                </p>

                <div class="mt-8 text-center">
                    <x-primary-button @click="showSuccess = false" class="w-full">
                        Close
                    </x-primary-button>
                </div>
            </div>
