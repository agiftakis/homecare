    ...
    <header class="bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-50">
        <nav x-data="{ open: false }" class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-6">
                <a href="{{ route('pricing') }}" class="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition duration-300">Pricing</a>
                <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition duration-300">Log In</a>
                <a href="{{ route('register') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-5 rounded-lg transition duration-300 shadow-md">
                    Get Started
                </a>
            </div>
    ...
    <main>
        ...
        <section class="py-20 bg-gray-50 dark:bg-gray-800">
            <div class="container mx-auto px-6 text-center">
                ...
                <h2 class="text-3xl md:text-4xl font-bold mt-2 mb-4 text-gray-900 dark:text-white">A Customizable Software Solution</h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-16">VitaLink provides the tools you need to operate efficiently, stay compliant, and provide the best possible care.</p>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <!-- Feature 1 -->
                    <div class="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg flex flex-col">
                        <img src="{{ asset('images/icon-schedule.png') }}" alt="Scheduling Icon" class="h-16 w-16 mx-auto mb-4">
                        <h3 class="text-2xl font-bold mb-2">Intelligent Scheduling</h3>
                        <p class="text-gray-600 dark:text-gray-400 flex-grow">Easily create, manage, and update shifts with our intuitive calendar interface. Match the right caregiver to the right client, every time.</p>
                        <a href="#" class="mt-6 inline-block text-indigo-500 font-semibold hover:text-indigo-400">Learn more &rarr;</a>
                    </div>
                    <!-- Feature 2 -->
                    <div class="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg flex flex-col">
                        <img src="{{ asset('images/icon-client.png') }}" alt="Client Management Icon" class="h-16 w-16 mx-auto mb-4">
                        <h3 class="text-2xl font-bold mb-2">Centralized Client Data</h3>
                        <p class="text-gray-600 dark:text-gray-400 flex-grow">Keep all client information, care plans, and contact details organized and accessible in one secure location.</p>
                        <a href="#" class="mt-6 inline-block text-indigo-500 font-semibold hover:text-indigo-400">Learn more &rarr;</a>
                    </div>
                    <!-- Feature 3 -->
                    <div class="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg flex flex-col">
                        <img src="{{ asset('images/icon-communication.png') }}" alt="Communication Icon" class="h-16 w-16 mx-auto mb-4">
                        <h3 class="text-2xl font-bold mb-2">Seamless Communication</h3>
                        <p class="text-gray-600 dark:text-gray-400 flex-grow">Our platform facilitates clear and secure communication between your office, caregivers, and clients.</p>
                        <a href="#" class="mt-6 inline-block text-indigo-500 font-semibold hover:text-indigo-400">Learn more &rarr;</a>
                    </div>
                </div>
            </div>
