    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl w-full bg-white dark:bg-gray-800 shadow-2xl rounded-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-10 text-center">
                ...
                <p class="mt-2 font-bold text-blue-400 text-sm sm:text-base">Access to VitaLink services has been
            ...
            <div class="px-6 sm:px-10 py-10">
                ...
                <div
                    class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-700 rounded-xl p-6 sm:p-8 mb-8 border border-blue-100 dark:border-gray-600">
                    <div class="flex items-start mb-4">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="text-base text-gray-600 dark:text-gray-300 mb-4">
                                If you believe this is an error or would like to resolve this issue, please contact our
                                support team:
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        class="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4">
                        <div
                            class="flex items-center justify-center space-x-2 bg-white dark:bg-gray-800 px-4 py-3 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600">
                ...
                <div class="text-center">
                    <form method="POST" action="{{ route('logout') }}" class="inline-block">
                        @csrf
                        <button type="submit"
                            class="inline-flex items-center mb-6 px-8 py-3 bg-gray-800 hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition duration-200 ease-in-out transform hover:-translate-y-0.5">
            ...
            {{-- Footer --}}
            <div
                class="bg-gray-50 dark:bg-gray-700/50 px-6 sm:px-10 py-6 text-center border-t border-gray-200 dark:border-gray-600">
