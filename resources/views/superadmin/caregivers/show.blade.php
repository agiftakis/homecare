<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Edit Caregiver: {{ $caregiver->first_name }} {{ $caregiver->last_name }} <span class="text-base text-gray-500"> (Agency: {{ $caregiver->agency->name }})</span>
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('superadmin.caregivers.update', $caregiver) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-8 border-t border-gray-200 dark:border-gray-700 pt-8">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Documents (All Optional)</h3>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border dark:border-gray-700">
                                    ...
                                    @else
                                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 mb-3">No document uploaded yet.</p>
                                    @endif
                                    <input id="certifications_document" name="certifications_document" type="file" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-green-50 dark:file:bg-green-900 file:text-green-700 dark:file:text-green-300 hover:file:bg-green-100 dark:[color-scheme:dark]" accept=".pdf,.docx,.jpeg,.jpg,.png,.gif">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Accepted formats: PDF, DOCX, JPG, PNG, GIF (Max: 10MB)</p>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border dark:border-gray-700">
                                    ...
                                    @else
                                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 mb-3">No document uploaded yet.</p>
                                    @endif
                                    <input id="professional_licenses_document" name="professional_licenses_document" type="file" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 dark:file:bg-blue-900 file:text-blue-700 dark:file:text-blue-300 hover:file:bg-blue-100 dark:[color-scheme:dark]" accept=".pdf,.docx,.jpeg,.jpg,.png,.gif">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Accepted formats: PDF, DOCX, JPG, PNG, GIF (Max: 10MB)</p>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border dark:border-gray-700">
                                    ...
                                    @else
                                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 mb-3">No document uploaded yet.</p>
                                    @endif
                                    <input id="state_province_id_document" name="state_province_id_document" type="file" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-purple-50 dark:file:bg-purple-900 file:text-purple-700 dark:file:text-purple-300 hover:file:bg-purple-100 dark:[color-scheme:dark]" accept=".pdf,.docx,.jpeg,.jpg,.png,.gif">
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Accepted formats: PDF, DOCX, JPG, PNG, GIF (Max: 10MB)</p>
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="flex items-center">
                                <a href="{{ route('superadmin.caregivers.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Cancel
                                </a>
