                        ...
                        @forelse ($clients as $client)
                            <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border dark:border-gray-700">
                                ...
                                <div class="mt-4 text-right">
                                     <a href="{{ route('superadmin.clients.show', $client) }}" class="inline-flex items-center px-3 py-1.5 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                        View/Edit Profile
                                     </a>
                                </div>
                            </div>
                            ...
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="relative px-6 py-3">
                                        <span class="sr-only">View/Edit Profile</span>
                                    </th>
                                </tr>
                            </thead>
                                ...
                                @forelse ($clients as $client)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('superadmin.clients.show', $client) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">View/Edit Profile</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
