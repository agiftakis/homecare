<x-app-layout>
    <x-slot name="header">
        {{-- ✅ MOBILE OPTIMIZED: Responsive header with stacking on small screens --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 sm:p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- ✅ MOBILE OPTIMIZED: Statistics cards with better mobile spacing --}}
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                        <div
                            class="bg-green-50 dark:bg-green-900 p-4 rounded-lg border border-green-200 dark:border-green-700">
                            <div class="flex items-center">
                                <div class="p-2 bg-green-100 dark:bg-green-800 rounded-lg flex-shrink-0">
                                ...
                                <div class="ml-4">
                                    <p class="text-xs sm:text-sm font-medium text-green-600 dark:text-green-300">Paid
                                        Invoices</p>
                                    <p class="text-xl sm:text-2xl font-bold text-green-800 dark:text-green-100">
                                        {{ $statistics['paid_count'] ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                <div class="p-2 bg-yellow-100 dark:bg-yellow-800 rounded-lg flex-shrink-0">
                                ...
                                <div class="ml-4">
                                    <p class="text-xs sm:text-sm font-medium text-yellow-600 dark:text-yellow-300">
                                        Pending</p>
                                    <p class="text-xl sm:text-2xl font-bold text-yellow-800 dark:text-yellow-100">
                                        {{ $statistics['pending_count'] ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-red-50 dark:bg-red-900 p-4 rounded-lg border border-red-200 dark:border-red-700">
                            <div class="flex items-center">
                                <div class="p-2 bg-red-100 dark:bg-red-800 rounded-lg flex-shrink-0">
                                ...
                                <div class="ml-4">
                                    <p class="text-xs sm:text-sm font-medium text-red-600 dark:text-red-300">Overdue</p>
                                    <p class="text-xl sm:text-2xl font-bold text-red-800 dark:text-red-100">
                                        {{ $statistics['overdue_count'] ?? 0 }}</p>
                                </div>
                            </div>
                        </div>

                        <div
                            class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-300">Total
                                        Revenue</p>
                                    <p class="text-xl sm:text-2xl font-bold text-blue-800 dark:text-blue-100">
                                        ${{ number_format($statistics['total_revenue'] ?? 0, 2) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

                    {{-- ✅ MOBILE OPTIMIZED: Table with horizontal scroll and shadow indicators --}}
                                    ...
                                    <tbody
                                        ...
                                        @forelse($invoices as $invoice)
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                <td
                                                    class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-100">
                                                ...
                                                <td
                                                    class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-500 dark:text-gray-300">
                                                    {{-- ✅ MOBILE OPTIMIZED: Stacked action buttons on mobile --}}
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="6"
                                                        class="px-3 sm:px-6 py-8 text-center text-sm sm:text-base text-gray-500 dark:text-gray-400">
                                                        No invoices found.
                                                        <a href="{{ route('invoices.create') }}"
